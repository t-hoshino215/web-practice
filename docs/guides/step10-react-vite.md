...
| # | 手順 | ステータス | コミット |
| --- | --- | --- | --- |
| 10-1 | ゴールと構成を確認する | 未着手 | - |
| 10-2 | Node と pnpm を用意する | 未着手 | - |
| 10-3 | Viteプロジェクトの雛形を作る | 未着手 | - |
| 10-4 | テスト環境を整える | 未着手 | - |
| 10-5 | APIクライアントを実装する | 未着手 | - |
| 10-6 | 状態管理フックを実装する | 未着手 | - |
| 10-7 | UIコンポーネントを実装する | 未着手 | - |
| 10-8 | アプリを組み立てる | 未着手 | - |
| 10-9 | 開発サーバーで動作確認する | 未着手 | - |
| 10-10 | ビルド成果物をCaddyから配信する | 未着手 | - |
| 10-11 | 公開する | 未着手 | - |
| 10-12 | 動作確認 | 未着手 | - |
